...
// source-hash: 4f5cb834a349ceff6f746e1206bf0228b98b0bd1
let wasm;
 ...
 * @param {Uint8Array} buf
 */
export function with_dict(buf) {
  const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  wasm.with_dict(ptr0, len0);
}
...
async function instantiateModule(opts) {
  const wasmUrl = opts.url ?? new URL("deno_jieba_bg.wasm", import.meta.url);
